...
Translated to C# by Rhys Weatherley <rweather@southern-storm.com.au> Feb 2003
...
public class Linpack
{
    ...
    public static double[][] new2d(int dim1, int dim2)
    {
        double[][] array = new double[dim1][];
        int posn;
        for (posn = 0; posn < dim1; ++posn)
            array[posn] = new double[dim2];
        return array;
    }
    ...
    public void run_benchmark(int n, int ldaa)
    {
        ...
        */
        ...
        Console.Write("Mflops/s: ");
        Console.Write(mflops_result);
        Console.Write("  Time: ");
        Console.Write(time_result);
        Console.Write(" secs");
        Console.Write("  Norm Res: ");
        Console.Write(residn_result);
        Console.Write("  Precision: ");
        Console.Write(eps_result);
