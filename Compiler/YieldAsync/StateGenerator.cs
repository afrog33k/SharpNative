...
namespace SharpNative.Compiler.YieldAsync
{
    ...
    {
        public const string stateFieldName = "__state";
        ...
        public StateGenerator(Compilation compilation, MemberDeclarationSyntax node)
        {
        ...
        {
            return SyntaxFactory.GotoStatement(SyntaxKind.GotoStatement, SyntaxFactory.IdentifierName("_top"));
        }
